...
#SBATCH --output=nfs/concat-logs/ray-interview/%j.out
#SBATCH --error=nfs/concat-logs/ray-interview/%j.err

# Wait for the final output file to exist
OUTPUT_DIR="nfs/transcribed-ray-interview"
FILE_PATTERN=$1 
NUM_CHUNKS=$2
MISSING_FILES=false
BUCKET_NAME="transcription-ray-interview"

MAX_WAIT=60  # 1 minute
START_TIME=$(date +%s)
FAILED_FILES_LOG="nfs/concat-logs/ray-interview_failed_files.txt"
